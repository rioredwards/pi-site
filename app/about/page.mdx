...
This is all facilitated by DNS providers (like [Cloudflare](https://www.cloudflare.com/)), who have servers all over the world for directing traffic. Your computer asks your router for `pi.rioredwards.com`, which eventually reaches Cloudflare, and they route the request to my Raspberry Pi.
...
<div className="not-prose">
  <LightboxImage
    ...
    caption={
      <div>
        <Link href="https://github.com/rioedwards/fz-cmd" className="text-primary" target="_blank">
          fz-cmd
        </Link>
        , built with{" "}
...
<div className="not-prose mt-6 flex gap-4">
  ...
  <Link href="https://bsky.app/profile/rioedwards.bsky.social" aria-label="Bluesky">
