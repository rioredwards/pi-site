...
<div className="not-prose mb-12 flex flex-col items-center text-center">
  ...
  <SocialLinks className="not-prose mt-6 flex gap-4" />
</div>
...
So, why would you want one? Raspberry Pis are perfect for DIY projects. You can build robots, smart home devices, or even host your own website—like I did.
...
So I challenged myself to dive into the world of self-hosting. It felt like the perfect opportunity to fill in some knowledge gaps—and get hands-on with my new Raspberry Pi.
...
They exchange data using IP addresses, URLs, and something called DNS—often referred to as the internet's "phone book."

For this project, I registered the domain `dogtown.dog` and pointed it to my Raspberry Pi. Now anyone can visit that domain and land on this site!

This is all facilitated by DNS providers (like [Cloudflare](https://www.cloudflare.com/)), who have servers all over the world for directing traffic. Your computer asks your router for `dogtown.dog`, which eventually reaches Cloudflare, and they route the request to my Raspberry Pi.
...
- Figure out why my Pi kept disconnecting 🫠
...
- <span className="inline">
  ...
  >
    <span className="inline rounded-full bg-background px-2">{`Glowing Gradient Border`}</span>
  </RotatingGradientBorder> 
...
- I built a browser-based image compression/conversion service to deal with large images and the HEIC file format, which is the default for iPhone images. As it turns out, there's essentially [no browser support for them 🤔](https://caniuse.com/?search=heif).
...
Docker makes things easier, but only if you know what you're doing 😅.

I spent more time learning Docker/Docker Compose than anything else in this project. It was worth it though. I learned a lot, and the process even inspired a [side project](https://github.com/rioredwards/fz-cmd): a CLI utility for quickly casting commands from your history.
...
<div className="not-prose">
  <LightboxImage
    ...
    caption={
      <div>
        <Link
          href="https://github.com/rioredwards/fz-cmd"
          className="text-primary"
          target="_blank"
        >
          fz-cmd
...
At this point, it was “feature-complete.” So naturally, I added more features. 🤷‍♂️
...
I learned a lot from this project. I deepened my knowlege of Docker, DevOps, Linux, bash scripting, networking and more. And these are skills that I'll benefit from for the rest of my career. Unless AI takes over... 🤔
