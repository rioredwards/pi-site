      ...
      <section className="mb-16 mt-8">
        <div className="flex flex-col items-center gap-12">
          ...
          <p className="mt-2 text-lg text-foreground">
            I&apos;m Rio, a{" "}
            <ColorfulUnderline color="green">
              Software Developer
            </ColorfulUnderline>{" "}
            and <ColorfulUnderline color="blue">Dog-Lover</ColorfulUnderline>{" "}
          ...
          <CardContent className="flex flex-col items-start gap-6 md:flex-row-reverse">
            ...
            <p>
              ...
              <PillHighlight color="red">
                Raspberry Pi{" "}
                <RaspberryPi className="-mt-[2px] mr-[2px] inline w-[16px]" />
              </PillHighlight>{" "}
              as a gift from my sister (best gift ever!). After some tinkering
              and late-night coding sessions, this little project came to
              life—my first
              <span className="font-bold"> self-hosted website</span>!
              <br />
              <br />
              Naturally, the <span className="italic">theme</span> is{" "}
              <span className="font-bold">dog photos</span> because, my life
              pretty much revolves around these majestic furballs. 🐶
            </p>
          </CardContent>
        </CardWithGradientBorder>
      </section>
      ...
      <section className="mb-12">
        <Flashcard question="What do Dogs and Computers have in common? 🤔">
          <div className="mx-auto w-full max-w-3xl py-8 text-center">
            ...
            />
            <GradientText className="animate-pulse">
              They make me Happy!
            </GradientText>
          </div>
        </Flashcard>
        ...
        >
          ...
          <CardContent className="flex flex-col items-start gap-6 md:flex-row">
            <div className="w-full rounded-lg bg-gray-100 p-6 shadow-md">
              <p>
                I started programming in 2021, and since then, I&apos;ve always
                relied
                <PillHighlight color="blue">The Cloud ☁️</PillHighlight> to
                deploy my websites.
                <br />
                <br />
                With this project, I wanted to step outside my comfort zone and
                dive into the world of{" "}
                <PillHighlight color="red">self-hosting 📡</PillHighlight>. It
                felt like the perfect way to fill some knowledge gaps, satisfy
                my curiosity, and get familiar with with my new Raspberry Pi.
                Building this site was a ton of fun—and I learned a lot along
                the way! 🧠
              </p>
            </div>
          </CardContent>
        ...
        >
          <CardHeader>
            <CardIcon>
              <Blocks
                key={5}
                className="h-full w-full text-gray-300 group-hover:text-green-500"
              />
            </CardIcon>
          ...
          <CardContent>
            <div className="mb-6 flex flex-col items-start gap-6 lg:flex-row">
              ...
              <ul className="list-disc space-y-2 pl-5">
                <li>
                  <strong>Coding:</strong> I write the code for this website on
                  my laptop and push updates to GitHub when I&apos;m ready to
                  deploy.
                </li>
                <li>
                  <strong>Deploying:</strong> I SSH into my Raspberry Pi and run
                  a shell script that pulls the latest code from GitHub,
                  installs dependencies, builds the project, and starts the
                  server. Originally, I considered setting up a CI/CD pipeline
                  with GitHub Actions, but that required SSH-ing into my Pi over
                  the public internet which was out of scope for this project.
                </li>
                <li>
                  <strong>Serving:</strong> I&apos;m using Cloudflare Tunnels to
                  securely route traffic from my domain to the Pi. This felt
                  easier (and safer) than setting up port forwarding on my
                  router. Since I reused the domain for my portfolio site
                  (rioredwards.com), I also had to transfer the domain from
                  Vercel to Cloudflare.
                </li>
                <li>
                  <strong>Connecting:</strong> My laptop connects to the
                  Raspberry Pi via Raspberry Pi Connect and SSH. I also hooked
                  the Pi up to a TV, along with a keyboard and mouse, so I can
                  control it directly if needed. Only one of these setups is
                  necessary, but I had fun experimenting with different ways to
                  access and manage it.
                </li>
                <li>
                  <strong>Tech stack:</strong> I built this site using Next.js,
                  React.js, ShadCN, Tailwind, and Node.js. I had some fun making
                  custom components, like these
                ...
                <li>
                  <strong>Persistence:</strong> No database here! Images are
                  stored as files in a directory, and their metadata lives in
                  JSON files. Authentication is handled via NextAuth.js with
                  GitHub OAuth, so users can only delete their own photos.
                </li>
              </ul>
            </div>
          </CardContent>
        ...
        >
          ...
          <CardContent>
            <div className="mb-6 flex flex-col items-start gap-6 md:flex-row">
              <div>
                <p className="mb-4">
                  Feel free to reach out with any comments, questions or
                  concerns!
                </p>
