...
import { CardContent, CardHeader, CardIcon, CardTitle, CardWithGradientBorder } from "@/components/ui/card";
import {
  Blocks,
  Lightbulb,
  LucideComputer,
          ...
          <CardContent>
            <div className="flex flex-col lg:flex-row items-start gap-6 mb-6">
              ...
              <ul className="list-disc pl-5 space-y-2">
                ...
                <li><strong>Tech stack:</strong> I built the site using Next.js and ShadCN, with some AI assistance from V0.</li>
