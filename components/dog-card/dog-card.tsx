...
export function DogCard({
  ...
  return (
    <>
      ...
      >
        <div className="absolute transition-all duration-200 ease-in-out inset-0">
          {loading && (
          ...
          <div
            className={cn(
              "absolute inset-0 bg-foreground/0 transition-colors duration-300 flex items-center justify-center",
          ...
          >
            ...
            {isOwner && (
              <button
                ...
                className={cn(
                  "invisible pointer-coarse:bg-destructive opacity-0 backdrop-blur-sm bg-background/70 group/delete absolute left-3 top-3 z-20 flex h-8 w-8 items-center justify-center rounded-full text-foreground shadow-md transition-all duration-200 ease-in-out hover:bg-destructive hover:text-destructive-foreground",
              ...
              >
                <HugeiconsIcon
                  icon={Trash2}
                  size={20}
                  className="text-foreground group-hover/delete:text-destructive-foreground transition-colors"
                />
              </button>
            )}
