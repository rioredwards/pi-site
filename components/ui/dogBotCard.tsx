...
export function DogBotCard({ processingState }: DogBotCardProps) {
  ...
  return (
    <div className="absolute inset-0 z-10 flex flex-col">
      ...
      <div className="relative z-20 flex min-w-[70%] flex-1 items-center justify-center px-6">
        <div className="flex w-full items-center gap-3 rounded-2xl bg-white/70 px-5 py-4 shadow-xl backdrop-blur-sm">
      ...
      <div className="absolute bottom-4 left-4 z-20">
        ...
        >
          ...
          >
            <div className="flex items-center gap-2 rounded-full bg-background px-4 py-2 shadow-lg backdrop-blur-sm">
              <span className="text-2xl">🤖</span>
              <div>
                <div className="text-sm leading-tight font-bold drop-shadow-md">
                  DogBot™
                </div>
                <div className="text-[10px] leading-tight drop-shadow-md">
 ...
 */
export function getDogBotBorderColors(
  processingState: ProcessingState,
): string[] {
  switch (processingState) {
    case "processing":
